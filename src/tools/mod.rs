                ...
                tools: {
                    ...
                    tools.insert(
                        ...
                        ToolDefinition {
                            ...
                            description: Some(
                                "Returns all information associated with the account".to_string(),
                            ),
                    ...
                    tools.insert(
                        ...
                        ToolDefinition {
                            ...
                            description: Some(
                                "Returns all accounts owned by the program".to_string(),
                            ),
                            input_schema: serde_json::json!({
                                "type": "object",
                                "properties": {
                    ...
                    tools.insert(
                        ...
                        ToolDefinition {
                            ...
                            description: Some(
                                "Returns the 20 largest accounts by lamport balance".to_string(),
                            ),
                            input_schema: serde_json::json!({
                                "type": "object",
                                "properties": {
                    ...
                    tools.insert(
                        ...
                        ToolDefinition {
                            ...
                            description: Some(
                                "Returns minimum balance for rent exemption".to_string(),
                            ),
                            input_schema: serde_json::json!({
                                "type": "object",
                                "properties": {
                    ...
                    tools.insert(
                        ...
                        ToolDefinition {
                            ...
                            description: Some(
                                "Returns the current slot the node is processing".to_string(),
                            ),
                            input_schema: serde_json::json!({
                                "type": "object",
                                "properties": {
                    ...
                    tools.insert(
                        ...
                        ToolDefinition {
                            ...
                            description: Some(
                                "Returns a list of confirmed blocks between two slots".to_string(),
                            ),
                            input_schema: serde_json::json!({
                                "type": "object",
                                "properties": {
                    ...
                    tools.insert(
                        ...
                        ToolDefinition {
                            ...
                            description: Some(
                                "Returns the lowest confirmed block still available".to_string(),
                            ),
                            input_schema: serde_json::json!({
                                "type": "object",
                                "properties": {}
                    ...
                    tools.insert(
                        "listSvmNetworks".to_string(),
                        ToolDefinition {
                            name: "listSvmNetworks".to_string(),
                            description: Some(
                                "List all available SVM networks from the awesome-svm repository"
                                    .to_string(),
                            ),
                            input_schema: serde_json::json!({
                                "type": "object",
                    ...
                    tools.insert(
                        "enableSvmNetwork".to_string(),
                        ToolDefinition {
                            name: "enableSvmNetwork".to_string(),
                            description: Some(
                                "Enable an SVM network for use in RPC requests".to_string(),
                            ),
                            input_schema: serde_json::json!({
                                "type": "object",
                                "properties": {
                    ...
                    tools.insert(
                        "setNetworkRpcUrl".to_string(),
                        ToolDefinition {
                            name: "setNetworkRpcUrl".to_string(),
                            description: Some(
                                "Override RPC URL for a specific network".to_string(),
                            ),
                            input_schema: serde_json::json!({
                                "type": "object",
                                "properties": {
                    ...
                    tools.insert(
                        ...
                        ToolDefinition {
                            ...
                            description: Some(
                                "Returns identity pubkey for the current node".to_string(),
                            ),
                            input_schema: serde_json::json!({
                                "type": "object",
                                "properties": {}
                    ...
                    tools.insert(
                        ...
                        ToolDefinition {
                            ...
                            description: Some(
                                "Returns information about the current epoch".to_string(),
                            ),
                            input_schema: serde_json::json!({
                                "type": "object",
                                "properties": {
                    ...
                    tools.insert(
                        ...
                        ToolDefinition {
                            ...
                            description: Some(
                                "Returns information about current supply".to_string(),
                            ),
                            input_schema: serde_json::json!({
                                "type": "object",
                                "properties": {
                    ...
                    tools.insert(
                        ...
                        ToolDefinition {
                            ...
                            description: Some(
                                "Returns signatures for address's transactions".to_string(),
                            ),
                            input_schema: serde_json::json!({
                                "type": "object",
                                "properties": {
                    ...
                    tools.insert(
                        ...
                        ToolDefinition {
                            ...
                            description: Some(
                                "Returns all token accounts by token owner".to_string(),
                            ),
                            input_schema: serde_json::json!({
                                "type": "object",
                                "properties": {
                    ...
                    tools.insert(
                        ...
                        ToolDefinition {
                            ...
                            description: Some(
                                "Returns total supply of an SPL Token type".to_string(),
                            ),
                            input_schema: serde_json::json!({
                                "type": "object",
                                "properties": {
                    ...
                    tools.insert(
                        ...
                        ToolDefinition {
                            ...
                            description: Some(
                                "Returns token balance of an SPL Token account".to_string(),
                            ),
                            input_schema: serde_json::json!({
                                "type": "object",
                                "properties": {
                    ...
                    tools.insert(
                        "getSlotLeaders".to_string(),
                        ToolDefinition {
                            name: "getSlotLeaders".to_string(),
                            description: Some(
                                "Returns slot leaders for a given slot range".to_string(),
                            ),
                            input_schema: serde_json::json!({
                                "type": "object",
                                "properties": {
                    ...
                    tools.insert(
                        "getBlockProduction".to_string(),
                        ToolDefinition {
                            name: "getBlockProduction".to_string(),
                            description: Some(
                                "Returns recent block production information".to_string(),
                            ),
                            input_schema: serde_json::json!({
                                "type": "object",
                                "properties": {
                    ...
                    tools.insert(
                        ...
                        ToolDefinition {
                            ...
                            description: Some(
                                "Returns the leader schedule for an epoch".to_string(),
                            ),
                            input_schema: serde_json::json!({
                                "type": "object",
                                "properties": {
                    ...
                    tools.insert(
                        ...
                        ToolDefinition {
                            ...
                            description: Some(
                                "Returns information about all cluster nodes".to_string(),
                            ),
                            input_schema: serde_json::json!({
                                "type": "object",
                                "properties": {}
                    ...
                    tools.insert(
                        ...
                        ToolDefinition {
                            ...
                            description: Some(
                                "Returns specific inflation values for current epoch".to_string(),
                            ),
                            input_schema: serde_json::json!({
                                "type": "object",
                                "properties": {}
                    ...
                    tools.insert(
                        "getInflationReward".to_string(),
                        ToolDefinition {
                            name: "getInflationReward".to_string(),
                            description: Some(
                                "Returns inflation reward for list of addresses".to_string(),
                            ),
                            input_schema: serde_json::json!({
                                "type": "object",
                                "properties": {
                    ...
                    tools.insert(
                        ...
                        ToolDefinition {
                            ...
                            description: Some(
                                "Returns current Transaction count from ledger".to_string(),
                            ),
                            input_schema: serde_json::json!({
                                "type": "object",
                                "properties": {
                    ...
                    tools.insert(
                        ...
                        ToolDefinition {
                            ...
                            description: Some(
                                "Returns estimated production time of a block".to_string(),
                            ),
                            input_schema: serde_json::json!({
                                "type": "object",
                                "properties": {
                    ...
                    tools.insert(
                        ...
                        ToolDefinition {
                            ...
                            description: Some(
                                "Returns all token accounts by approved delegate".to_string(),
                            ),
                            input_schema: serde_json::json!({
                                "type": "object",
                                "properties": {
                    ...
                    tools.insert(
                        ...
                        ToolDefinition {
                            ...
                            description: Some(
                                "Returns 20 largest accounts of a token type".to_string(),
                            ),
                            input_schema: serde_json::json!({
                                "type": "object",
                                "properties": {
                    ...
                    tools.insert(
                        "getStakeMinimumDelegation".to_string(),
                        ToolDefinition {
                    ...
                    tools.insert(
                        "getTransactionWithConfig".to_string(),
                        ToolDefinition {
                            name: "getTransactionWithConfig".to_string(),
                            description: Some(
                                "Returns transaction details with additional configuration"
                                    .to_string(),
                            ),
                            input_schema: serde_json::json!({
                                "type": "object",
        ...
        JsonRpcMessage::Request(req) => {
            ...
            match req.method.as_str() {
                ...
                "getProgramAccounts" => {
                    ...
                    let state = state.read().await;
                    let result =
                        crate::rpc::accounts::get_program_accounts(&state.rpc_client, &program_id)
                            .await?;
                    Ok(create_success_response(result, req.id))
                }
                ...
                "getMultipleAccounts" => {
                    ...
                    let state = state.read().await;
                    let result = if let Some(commitment_str) =
                        params.get("commitment").and_then(|v| v.as_str())
                    {
                        let commitment = match commitment_str {
                            "processed" => {
                                Some(solana_sdk::commitment_config::CommitmentConfig::processed())
                            }
                            "confirmed" => {
                        ...
                        crate::rpc::accounts::get_multiple_accounts_with_config(
                            &state.rpc_client,
                            &pubkeys,
                            commitment,
                            encoding,
                        ...
                        crate::rpc::accounts::get_multiple_accounts(&state.rpc_client, &pubkeys)
                            .await?
                    };
                    Ok(create_success_response(result, req.id))
                }
                ...
                "getLargestAccounts" => {
                    ...
                    let filter = params
                        ...
                        .map(|f| match f {
                            "circulating" => {
                                solana_client::rpc_config::RpcLargestAccountsFilter::Circulating
                            }
                            "nonCirculating" => {
                                solana_client::rpc_config::RpcLargestAccountsFilter::NonCirculating
                            }
                    ...
                    let state = state.read().await;
                    let result =
                        crate::rpc::accounts::get_largest_accounts(&state.rpc_client, filter)
                            .await?;
                    Ok(create_success_response(result, req.id))
                }
                ...
                "getMinimumBalanceForRentExemption" => {
                    ...
                    let data_size = params
                        .get("dataSize")
                        .and_then(|v| v.as_u64())
                        .ok_or_else(|| anyhow::anyhow!("Missing dataSize parameter"))?
                        as usize;

                    let state = state.read().await;
                    let result = crate::rpc::accounts::get_minimum_balance_for_rent_exemption(
                        &state.rpc_client,
                        data_size,
                    )
                    .await?;
                ...
                "getSlot" => {
                    ...
                    let result = if is_multi_network_mode(&state) {
                        ...
                        for network_id in state.get_enabled_networks() {
                            if let Some(client) = state.svm_clients.get(network_id) {
                                let slot_result = if let Some(commitment_str) =
                                    params.get("commitment").and_then(|v| v.as_str())
                                {
                                    let commitment = match commitment_str {
                                    ...
                                    crate::rpc::blocks::get_slot_with_commitment(client, commitment)
                                        .await
                                } else {
                            ...
                            params.get("commitment").and_then(|v| v.as_str())
                        {
                            ...
                            crate::rpc::blocks::get_slot_with_commitment(
                                &state.rpc_client,
                                commitment,
                            )
                            .await?
                ...
                "getBlock" => {
                    ...
                    let state = state.read().await;
                    let result =
                        if params.get("encoding").is_some()
                            || params.get("transactionDetails").is_some()
                            || params.get("rewards").is_some()
                            || params.get("commitment").is_some()
                        {
                            let encoding = params.get("encoding").and_then(|v| v.as_str()).map(
                                |e| match e {
                                    "json" => {
                            ...
                            let transaction_details = params
                            ...
                            crate::rpc::blocks::get_block_with_config(
                                &state.rpc_client,
                                slot,
                                encoding,
                                transaction_details,
                ...
                "getBlockHeight" => {
                        ...
                        params.get("commitment").and_then(|v| v.as_str())
                    {
                        ...
                        crate::rpc::blocks::get_block_height_with_commitment(
                            &state.rpc_client,
                            commitment,
                        )
                        .await?
                ...
                "getBlocks" => {
                        ...
                        params.get("commitment").and_then(|v| v.as_str())
                    {
                        ...
                        crate::rpc::blocks::get_blocks_with_commitment(
                            &state.rpc_client,
                            start_slot,
                            end_slot,
                            commitment,
                        ...
                        crate::rpc::blocks::get_blocks(&state.rpc_client, start_slot, end_slot)
                            .await?
                    };
                    Ok(create_success_response(result, req.id))
                }
                ...
                "getFirstAvailableBlock" => {
                    ...
                    let state = state.read().await;
                    let result =
                        crate::rpc::blocks::get_first_available_block(&state.rpc_client).await?;
                    Ok(create_success_response(result, req.id))
                }
                ...
                "enableSvmNetwork" => {
                    ...
                    let result =
                        enable_svm_network(state.clone(), network_id, name, rpc_url).await?;
                    Ok(create_success_response(result, req.id))
                }
                ...
                "getLatestBlockhash" => {
                        ...
                        params.get("commitment").and_then(|v| v.as_str())
                    {
                        ...
                        crate::rpc::system::get_latest_blockhash_with_commitment(
                            &state.rpc_client,
                            commitment,
                        )
                        .await?
                ...
                "getSupply" => {
                        ...
                        params.get("commitment").and_then(|v| v.as_str())
                    {
                        ...
                        crate::rpc::system::get_supply_with_commitment(
                            &state.rpc_client,
                            commitment,
                        )
                        .await?
                ...
                "getSignaturesForAddress" => {
                    ...
                    let state = state.read().await;
                    let result = crate::rpc::transactions::get_signatures_for_address(
                        &state.rpc_client,
                        &address,
                        before,
                        until,
                ...
                "sendTransaction" => {
                    ...
                    let state = state.read().await;
                    let result = if params.get("skipPreflight").is_some()
                        || params.get("maxRetries").is_some()
                    {
                        ...
                        crate::rpc::transactions::send_transaction(
                            &state.rpc_client,
                            transaction_data,
                            encoding,
                        )
                ...
                "simulateTransaction" => {
                    ...
                    let state = state.read().await;
                    let result = if params.get("sigVerify").is_some()
                        || params.get("commitment").is_some()
                    {
                        let sig_verify = params
                            .get("sigVerify")
                            .and_then(|v| v.as_bool())
                            .unwrap_or(true);
                        let commitment =
                        ...
                        crate::rpc::transactions::simulate_transaction(
                            &state.rpc_client,
                            transaction_data,
                            encoding,
                        )
                ...
                "getTokenAccountsByOwner" => {
                    ...
                    let state = state.read().await;
                    let result =
                        crate::rpc::tokens::get_token_accounts_by_owner(&state.rpc_client, &owner)
                            .await?;
                    Ok(create_success_response(result, req.id))
                }
                ...
                "getTokenSupply" => {
                        ...
                        params.get("commitment").and_then(|v| v.as_str())
                    {
                        ...
                        crate::rpc::tokens::get_token_supply_with_commitment(
                            &state.rpc_client,
                            &mint,
                            commitment,
                        )
                ...
                "getTokenAccountBalance" => {
                        ...
                        params.get("commitment").and_then(|v| v.as_str())
                    {
                        ...
                        crate::rpc::tokens::get_token_account_balance_with_commitment(
                            &state.rpc_client,
                            &account,
                            commitment,
                        )
                        ...
                        crate::rpc::tokens::get_token_account_balance(&state.rpc_client, &account)
                            .await?
                    };
                    Ok(create_success_response(result, req.id))
                }
                ...
                "getSlotLeaders" => {
                    ...
                    let state = state.read().await;
                    let result =
                        crate::rpc::blocks::get_slot_leaders(&state.rpc_client, start_slot, limit)
                            .await?;
                    Ok(create_success_response(result, req.id))
                }
                ...
                "getBlockProduction" => {
                    ...
                    let state = state.read().await;
                    let result = crate::rpc::blocks::get_block_production(
                        &state.rpc_client,
                        identity,
                        first_slot,
                        last_slot,
                ...
                "getVoteAccounts" => {
                    ...
                    let vote_pubkey = params
                        .get("votePubkey")
                        .and_then(|v| v.as_str())
                        .map(|s| s.to_string());
                    let keep_unstaked_delinquents = params
                        .get("keepUnstakedDelinquents")
                        .and_then(|v| v.as_bool());

                    let state = state.read().await;
                    let result = if commitment.is_some()
                        || vote_pubkey.is_some()
                        || keep_unstaked_delinquents.is_some()
                    {
                        crate::rpc::blocks::get_vote_accounts_with_config(
                            &state.rpc_client,
                            commitment,
                            vote_pubkey,
                ...
                "getLeaderSchedule" => {
                    ...
                    let state = state.read().await;
                    let result =
                        crate::rpc::blocks::get_leader_schedule(&state.rpc_client, slot, identity)
                            .await?;
                    Ok(create_success_response(result, req.id))
                }
                ...
                "getInflationGovernor" => {
                    ...
                    let state = state.read().await;
                    let result =
                        crate::rpc::system::get_inflation_governor(&state.rpc_client).await?;
                    Ok(create_success_response(result, req.id))
                }
                ...
                "getInflationReward" => {
                    ...
                    let state = state.read().await;
                    let result = crate::rpc::system::get_inflation_reward(
                        &state.rpc_client,
                        &addresses,
                        epoch,
                    )
                ...
                "getTransactionCount" => {
                    ...
                    let result = if is_multi_network_mode(&state) {
                        ...
                        for network_id in state.get_enabled_networks() {
                            if let Some(client) = state.svm_clients.get(network_id) {
                                let count_result = if let Some(commitment_str) =
                                    params.get("commitment").and_then(|v| v.as_str())
                                {
                                    let commitment = match commitment_str {
                                        "processed" => solana_sdk::commitment_config::CommitmentConfig::processed(),
                                    ...
                                    crate::rpc::system::get_transaction_count_with_commitment(
                                        client, commitment,
                                    )
                                    .await
                                } else {
                ...
                "requestAirdrop" => {
                    ...
                    let state = state.read().await;
                    let result =
                        crate::rpc::system::request_airdrop(&state.rpc_client, &pubkey, lamports)
                            .await?;
                    Ok(create_success_response(result, req.id))
                }
                ...
                "getBlockTime" => {
                    ...
                    let state = state.read().await;
                    let result =
                        crate::rpc::transactions::get_block_time(&state.rpc_client, slot).await?;
                    Ok(create_success_response(result, req.id))
                }
                ...
                "getFeeForMessage" => {
                    ...
                    let state = state.read().await;
                    let result = crate::rpc::transactions::get_fee_for_message(
                        &state.rpc_client,
                        message_data,
                        encoding,
                    )
                ...
                "getTokenAccountsByDelegate" => {
                    ...
                    } else if let Some(program_id_str) =
                        params.get("programId").and_then(|v| v.as_str())
                    {
                        let program_id = Pubkey::try_from(program_id_str)?;
                    ...
                    let state = state.read().await;
                    let result = crate::rpc::tokens::get_token_accounts_by_delegate(
                        &state.rpc_client,
                        &delegate,
                        filter,
                    )
                ...
                "getTokenLargestAccounts" => {
                        ...
                        params.get("commitment").and_then(|v| v.as_str())
                    {
                        ...
                        crate::rpc::tokens::get_token_largest_accounts_with_commitment(
                            &state.rpc_client,
                            &mint,
                            commitment,
                        )
                        ...
                        crate::rpc::tokens::get_token_largest_accounts(&state.rpc_client, &mint)
                            .await?
                    };
                    Ok(create_success_response(result, req.id))
                }
                ...
                "getBlocksWithLimit" => {
                        ...
                        params.get("commitment").and_then(|v| v.as_str())
                    {
                        ...
                        crate::rpc::blocks::get_blocks_with_limit_and_commitment(
                            &state.rpc_client,
                            start_slot,
                            limit,
                            commitment,
                        ...
                        crate::rpc::blocks::get_blocks_with_limit(
                            &state.rpc_client,
                            start_slot,
                            limit,
                        )
                ...
                "getStakeMinimumDelegation" => {
                        ...
                        params.get("commitment").and_then(|v| v.as_str())
                    {
                        ...
                        crate::rpc::system::get_stake_minimum_delegation_with_commitment(
                            &state.rpc_client,
                            commitment,
                        )
                        .await?
                ...
                "getTransactionWithConfig" => {
                    ...
                    let max_supported_transaction_version = params
                        .get("maxSupportedTransactionVersion")
                        .and_then(|v| v.as_u64())
                        .map(|v| v as u8);

                    let state = state.read().await;
                    let result = crate::rpc::transactions::get_transaction_with_config(
                        &state.rpc_client,
                        &signature,
                        encoding,
                        commitment,
